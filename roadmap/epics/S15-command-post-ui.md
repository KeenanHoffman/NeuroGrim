...
### S15-C-3: Built-in Logs page (3 days) — ✅ ALL 6 SOURCES + DRILL-DOWN SHIPPED (v1: publish-gates + approvals; v2 expansion: invocation-ledger + notifications + score-history + services.jsonl + per-row drill-down modal). Remaining polish: toast notifications for new events while on other pages.
