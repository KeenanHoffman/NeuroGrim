...
| **C** | **SDK Extraction** — IN PROGRESS (V5-SDK-1 ✅ COMPLETE 2026-05-03; V5-SDK-2 ◐ PARTIAL COMPLETE 2026-05-04 — feature-gate + walkthrough shipped; TestRunner suite gated on V5-FOUND-4 → V5-FOUND-3 deferral chain) | V5-SDK-1..2 | ~2–3 weeks | Theme B |
