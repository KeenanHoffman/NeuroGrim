//! A2A (Agent2Agent) peer protocol for NeuroGrim.
//!
...
//! invocation and Brain-as-tool exposure to LLM agents live in `neurogrim-mcp`. See
//! `METHODOLOGY-EVOLUTION.md` §6 for the protocol-split rationale.
//!
//! **Invariant (CI-enforced):** this crate MUST NOT import from `rmcp` or
//! `neurogrim-mcp`. The two protocols are orthogonal.
//!
//! # Module Map
//!
