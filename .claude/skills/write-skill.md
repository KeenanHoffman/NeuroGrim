...
Role: <role-tag from taxonomy — see the guide>
...
- Using `## When to Use This Skill` as a section header instead of the lead
  ...
  this content never appears in the routing index.
...
1. **Title** — imperative verb phrase H1.
...
4. **Trigger phrases** — 4-8 comma-separated natural-language phrases.
...
- [ ] Lead paragraph passes `capability-hygiene` domain check
