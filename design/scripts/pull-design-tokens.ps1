...
# .\pull-design-tokens.ps1 -Consumer ide -ConsumerRoot D:\local-pc-operational-management\children\neurogrim-ide
# .\pull-design-tokens.ps1 -Consumer dashboard -ConsumerRoot D:\Brains\NeuroGrim\neurogrim\crates\neurogrim-dashboard\frontend
# .\pull-design-tokens.ps1 -Consumer cli       -ConsumerRoot D:\Brains\NeuroGrim\neurogrim\crates\neurogrim-cli
#
...
Write-Host '[pull-design-tokens.ps1] STUB — design system has not migrated yet.' -ForegroundColor Yellow
Write-Host 'See D:/Brains/NeuroGrim/.claude/plans/design-migration-execution.md for the active execution plan.' -ForegroundColor Yellow
Write-Host 'Until step 2 of that plan executes, the source files remain at neurogrim-ide/design/system/.'
exit 0
